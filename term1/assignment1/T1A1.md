...
Ideas:
- Google employee sacked for revealing AI identification technology produced higher error rates for women with darker skin tones (Timnit Gebru)
- Penetration tester hacked worker's personal computer and found child pornography material and reported it despite confidentiality agreement
- Edward Snowden - US Defence whistleblower ?
- Fictional case study on aerospace engineer who signs off on plane tracking device with potentially dangerous bug (Michael McFarland) https://onlineethics.org/cases/occidental-engineering
- Case study: Personnel Threat https://ovic.vic.gov.au/information-security/risk-scenario-3-personnel-security-case-study/
