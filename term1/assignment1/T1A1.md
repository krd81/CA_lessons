...
> Citation: Built-in types (no date) Python documentation. Available at: https://docs.python.org/3/library/stdtypes.html (Accessed: 08 October 2023). Lists are mutable sequences, typically used to store collections of homogeneous items (where the precise degree of similarity will vary by application).
>
> (No date a) Python lists. Available at: https://www.w3schools.com/python/python_lists.asp (Accessed: 08 October 2023). 
...
> Citation: Built-in types (no date a) Python documentation. Available at: https://docs.python.org/3/library/stdtypes.html#set-types-set-frozenset (Accessed: 08 October 2023). 
>
> (No date a) Python sets. Available at: https://www.w3schools.com/python/python_sets.asp (Accessed: 08 October 2023). 
...
> Citation: Built-in types (no date a) Python documentation. Available at: https://docs.python.org/3/library/stdtypes.html#tuples (Accessed: 08 October 2023). 
>
> (No date a) Python tuples. Available at: https://www.w3schools.com/python/python_tuples.asp (Accessed: 08 October 2023). 
...
<br><br>
## Q12
Python sets the data type of variables depending on the value that is assigned to it. In this case `celsius` would be assigned as a `str` because Python assumes input coming from the user will be of type string.
